...
function myarcade_uninstall()
{
	...
	$db->delete_query("templates", "title IN('arcade','arcade_categories','arcade_category_bit','arcade_category_bit_image','arcade_champions','arcade_champions_bit','arcade_edit','arcade_edited','arcade_edit_error','arcade_edit_error_nomodal','arcade_favorite','arcade_favorites','arcade_gamebit','arcade_gamebit_champ','arcade_gamebit_favorite','arcade_gamebit_new','arcade_gamebit_rating','arcade_gamebit_score','arcade_gamebit_tournaments','arcade_menu','arcade_no_display','arcade_no_games','arcade_online','arcade_online_memberbit','arcade_play_rating','arcade_play','arcade_play_guest','arcade_play_tournament','arcade_scoreboard','arcade_scoreboard_bit','arcade_scores','arcade_scores_bit','arcade_scores_delete','arcade_scores_edit','arcade_scores_no_scores','arcade_scores_play','arcade_scores_rating','arcade_search','arcade_search_catagory','arcade_search_results','arcade_settings','arcade_settings_gamesselect','arcade_settings_gamesselect_option','arcade_settings_scoreselect','arcade_settings_scoreselect_option','arcade_settings_tournamentnotify','arcade_settings_whosonline','arcade_settings_champpostbit','arcade_statistics','arcade_statistics_bestplayers','arcade_statistics_bestplayers_avatar','arcade_statistics_bestplayers_bit','arcade_statistics_gamebit','arcade_statistics_no_champs','arcade_statistics_no_games','arcade_statistics_no_scores','arcade_statistics_scorebit','arcade_stats','arcade_stats_bit','arcade_stats_tournaments','arcade_stats_details','arcade_tournaments','arcade_tournaments_cancelled','arcade_tournaments_create','arcade_tournaments_user','arcade_tournaments_user_game')");
	$db->delete_query("templates", "title IN('global_arcade_bit','member_profile_arcade','header_menu_arcade','tournaments_cancel','tournaments_cancel_error','tournaments_cancel_error_nomodal','tournaments_cancel_success','tournaments_cancelled','tournaments_cancelled_bit','tournaments_create','tournaments_create_days','tournaments_create_game','tournaments_create_round','tournaments_create_tries','tournaments_finished','tournaments_finished_bit','tournaments_no_tournaments','tournaments_running','tournaments_running_bit','tournaments_view','tournaments_view_cancel','tournaments_view_delete','tournaments_view_join','tournaments_view_play','tournaments_view_rounds','tournaments_view_rounds_bit','tournaments_view_rounds_bit_info','tournaments_view_rounds_champion','tournaments_view_rounds_disqualify','tournaments_waiting','tournaments_waiting_bit')");
...
function myarcade_deactivate()
{
	...
	$db->delete_query("templates", "title IN('tournaments_cancel','tournaments_cancel_error','tournaments_cancel_error_nomodal','tournaments_cancel_success','tournaments_cancelled','tournaments_cancelled_bit','tournaments_create','tournaments_create_days','tournaments_create_game','tournaments_create_round','tournaments_create_tries','tournaments_finished','tournaments_finished_bit','tournaments_no_tournaments','tournaments_running','tournaments_running_bit','tournaments_view','tournaments_view_cancel','tournaments_view_delete','tournaments_view_join','tournaments_view_play','tournaments_view_rounds','tournaments_view_rounds_bit','tournaments_view_rounds_bit_info','tournaments_view_rounds_champion','tournaments_view_rounds_disqualify','tournaments_waiting','tournaments_waiting_bit') AND sid='-2'");
