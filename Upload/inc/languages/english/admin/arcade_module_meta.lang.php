...
$l['admin_log_arcade_games_import'] = "Imported {1} games";
$l['admin_log_arcade_games_export'] = "Exported {1} games";
...
$l['admin_log_arcade_scores_edit'] = "Edited score #{1} by user #{2}";
$l['admin_log_arcade_scores_delete'] = "Deleted score #{1} by user #{2}";
